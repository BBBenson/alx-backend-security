...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-uh$vq8)9+pi^%-q+3a540j!i0ckgv*4y&33xu6@kib(ct4z_om')
...
MIDDLEWARE = [
    ...
    'tracking.middleware.IPLoggingMiddleware',
]
...
RATELIMIT_VIEW = 'tracking.views.rate_limit_view'
